...
// RTMultica: default to self-hosted server instead of upstream cloud.
// wsUrl is derived from apiUrl (same host/port, protocol wss://, path /ws).
export const DEFAULT_RUNTIME_CONFIG: RuntimeConfig = Object.freeze({
  schemaVersion: 1,
  apiUrl: "https://mtcsrv.naivehero.top:8443",
  wsUrl: "wss://mtcsrv.naivehero.top:8443/ws",
  appUrl: "https://mtc.naivehero.top:8443",
});
